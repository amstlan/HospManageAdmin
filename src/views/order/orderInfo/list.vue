<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="outTradeNo" label="订单交易号" width="140" />
      <el-table-column prop="hosname" label="医院名称" width="110" />
      ...
      <el-table-column prop="number" label="预约号序" width="60" />
      <el-table-column prop="amount" label="服务费" width="60" />
